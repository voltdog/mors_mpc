...
class imu_lcm_data(object):
    __slots__ = ["orientation_quaternion", "orientation_euler", "orientation_covariance", "angular_velocity", "angular_velocity_covariance", "linear_acceleration", "linear_acceleration_covariance", "magnetic_field", "magnetic_field_covariance", "temperature", "temperature_variance"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[4], [3], [9], [3], [9], [3], [9], [3], [9], None, None]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xe6edfaee2aa2bd8f) & 0xffffffffffffffff
    ...
    def get_hash(self):
        ...
        return struct.unpack(">Q", imu_lcm_data._get_packed_fingerprint())[0]
