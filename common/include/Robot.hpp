...
public:
    ...
    std::vector<Eigen::Matrix3d> GetFootJacobianWorld(const VectorXd &q);
    std::vector<Eigen::Matrix3d> GetFootJacobianDotWorld(const VectorXd &q, const VectorXd &v);
    void GetLegDynamics(const Eigen::VectorXd& q,
