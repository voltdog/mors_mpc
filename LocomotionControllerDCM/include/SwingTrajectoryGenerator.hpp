...
public:
    ...
    void set_points(const std::vector<std::array<double, 3>>& p_start,
                    ...
                    const std::vector<std::array<double, 3>>& dd_p_start);
    void set_leg_timing(const std::vector<double>& segment_duration,
                        const std::vector<bool>& single_segment_z);
    void reset_offsets();
...
private:
    ...
    std::tuple<double, double, double> map_z_rising(int leg_num, double it,
        ...
        const std::array<double, 3>& dd_p_start,
        double tf, int cnt);
    ...
    std::vector<double> segment_duration;
    std::vector<bool> single_segment_z;
