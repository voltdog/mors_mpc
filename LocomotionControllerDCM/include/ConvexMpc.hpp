...
public:
    ...
    VectorXd get_contact_forces(const VectorXd& x0, const VectorXd& x_ref_vec,
...
private:
    ...
    void calc_QP_matrices(const int planning_horizon_steps, const VectorXd& x0, const VectorXd& state_ref_vec,
