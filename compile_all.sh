...
PROJECTS=("StateEstimatorMK" "StateEstimatorLKF" "StateEstimator" "WBIC" "LegController" "MorsLogger" "LocomotionController" "HeightMapBuilder") # "RealsenseCamera" "BHI360_IMU")
